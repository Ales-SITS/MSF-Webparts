...
export interface IButtonMsfProps {
  ...
  link2: string; suffix2: string; label2: string; blank2: boolean; icon2: boolean; iconPicker2: string; width2: string; height2: string; borderRadius2: string; color2: string; margin2: string; textAlignment2:string; textSize2:string; textColor2: string;
  link3: string; suffix3: string; label3: string; blank3: boolean; icon3: boolean; iconPicker3: string; width3: string; height3: string; borderRadius3: string; color3: string; margin3: string; textAlignment3:string; textSize3:string; textColor3: string;
  link4: string; suffix4: string; label4: string; blank4: boolean; icon4: boolean; iconPicker4: string; width4: string; height4: string; borderRadius4: string; color4: string; margin4: string; textAlignment4:string; textSize4:string; textColor4: string;
  link5: string; suffix5: string; label5: string; blank5: boolean; icon5: boolean; iconPicker5: string; width5: string; height5: string; borderRadius5: string; color5: string; margin5: string; textAlignment5:string; textSize5:string; textColor5: string;
  link6: string; suffix6: string; label6: string; blank6: boolean; icon6: boolean; iconPicker6: string; width6: string; height6: string; borderRadius6: string; color6: string; margin6: string; textAlignment6:string; textSize6:string; textColor6: string;
  link7: string; suffix7: string; label7: string; blank7: boolean; icon7: boolean; iconPicker7: string; width7: string; height7: string; borderRadius7: string; color7: string; margin7: string; textAlignment7:string; textSize7:string; textColor7: string;
  link8: string; suffix8: string; label8: string; blank8: boolean; icon8: boolean; iconPicker8: string; width8: string; height8: string; borderRadius8: string; color8: string; margin8: string; textAlignment8:string; textSize8:string; textColor8: string;
  link9: string; suffix9: string; label9: string; blank9: boolean; icon9: boolean; iconPicker9: string; width9: string; height9: string; borderRadius9: string; color9: string; margin9: string; textAlignment9:string; textSize9:string; textColor9: string;
  link10: string; suffix10: string; label10: string; blank10: boolean; icon10: boolean; iconPicker10: string; width10: string; height10: string; borderRadius10: string; color10: string; margin10: string; textAlignment10:string; textSize10:string; textColor10: string;
}
...
export default class ButtonMsfWebPart extends BaseClientSideWebPart<IButtonMsfProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IButtonMsfProps> = React.createElement(
      ButtonMsfHandler,
      {
        ...
        link2: this.properties.link2, suffix2: this.properties.suffix2, label2: this.properties.label2, blank2: this.properties.blank2, icon2: this.properties.icon2, iconPicker2: this.properties.iconPicker2, width2: this.properties.width2, height2: this.properties.height2, borderRadius2: this.properties.borderRadius2, color2: this.properties.color2, margin2: this.properties.margin2, textAlignment2:this.properties.textAlignment2, textSize2:this.properties.textSize2, textColor2:this.properties.textColor2,
        link3: this.properties.link3, suffix3: this.properties.suffix3, label3: this.properties.label3, blank3: this.properties.blank3, icon3: this.properties.icon3, iconPicker3: this.properties.iconPicker3, width3: this.properties.width3, height3: this.properties.height3, borderRadius3: this.properties.borderRadius3, color3: this.properties.color3, margin3: this.properties.margin3, textAlignment3:this.properties.textAlignment3, textSize3:this.properties.textSize3, textColor3:this.properties.textColor3,
        link4: this.properties.link4, suffix4: this.properties.suffix4, label4: this.properties.label4, blank4: this.properties.blank4, icon4: this.properties.icon4, iconPicker4: this.properties.iconPicker4, width4: this.properties.width4, height4: this.properties.height4, borderRadius4: this.properties.borderRadius4, color4: this.properties.color4, margin4: this.properties.margin4, textAlignment4:this.properties.textAlignment4, textSize4:this.properties.textSize4, textColor4:this.properties.textColor4,
        ...
        link6: this.properties.link6, suffix6: this.properties.suffix6, label6: this.properties.label6, blank6: this.properties.blank6, icon6: this.properties.icon6, iconPicker6: this.properties.iconPicker6, width6: this.properties.width6, height6: this.properties.height6, borderRadius6: this.properties.borderRadius6, color6: this.properties.color6, margin6: this.properties.margin6, textAlignment6:this.properties.textAlignment6, textSize6:this.properties.textSize6, textColor6:this.properties.textColor6,
        ...
        link8: this.properties.link8, suffix8: this.properties.suffix8, label8: this.properties.label8, blank8: this.properties.blank8, icon8: this.properties.icon8, iconPicker8: this.properties.iconPicker8, width8: this.properties.width8, height8: this.properties.height8, borderRadius8: this.properties.borderRadius8, color8: this.properties.color8, margin8: this.properties.margin8, textAlignment8:this.properties.textAlignment8, textSize8:this.properties.textSize8, textColor8:this.properties.textColor8,
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    ...
    const pagesArray = [ 
      {
      header: {
        description: "Welcome! On this page (1), you can set number of buttons (up to 10) and their general layout, add set your button 1. Other buttons inherit its visual settings, but you can change it at the next pages (i.e. button 2 = page(2)). You can also use dynamic URL with an optional input field. The input value is added between standard link and suffix part."
      },
